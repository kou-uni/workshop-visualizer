...
const ONLINE_TILES = [
  { k: 'REMOTE-1', n: '黙々タイム（個人作業）', d: '自分のプロダクトを個人で振り返り、提出する', href: '/remote/input' },
  { k: 'REMOTE-2', n: '黙々タイムの結果（sparkにて操作）', d: 'みんなの振り返りをAIが集約した結果を見る', href: '/remote/result' },
  { k: 'REMOTE-3', n: '個人の振り返り（発表用）', d: 'Discord名ごとに、4つの振り返りを表示して発表', href: '/remote/people' },
  { k: 'REMOTE-4', n: '気づきメモ（チーム議論）', d: '話しながら気づいたことを、その場でメモする', href: '/remote/feedback' },
  { k: 'REMOTE-5', n: 'オンライン集約（sparkにて操作）', d: 'オンライン全体をAIで集約し、解釈を映す', href: '/remote/admin' },
];
const REAL_TILES = [
  { k: 'ONSITE-1', n: '振り返り録音（代表者）', d: 'チームの議論を代表者が録音して、提出する', href: '/onsite/record' },
  { k: 'ONSITE-2', n: 'チームの振り返り', d: 'チームを選んで、AIの振り返りを見る', href: '/onsite/teams' },
  { k: 'ONSITE-3', n: 'リアル会場集計（sparkにて操作）', d: 'ONSITE全体をまとめて、会場に映す', href: '/onsite/live' },
];
    ...
    <>
      ...
      <div className="gal">
        ...
        <h1 style={{ margin: '6px 0 18px', fontSize: 28 }}>
          これまでの取り組みを、<br className="sp-br" />語り合おう
        </h1>
